...
///import { NgtUniversalModul } from '@ng-toolkit/universal';
...
import { NgOptimizedImage } from '@angular/common'
 ...
 @NgModule({
  ...
  imports: [
    ...
    { path: 'itemDetail/:itemid/:sizeId', loadChildren: () => import('../app/pages/itemdetails/itemdetail.module').then(m => m.ItemdetailsModule) },
...
], { onSameUrlNavigation: 'reload', initialNavigation: 'enabledBlocking' }),
     //////// SliderModule,
